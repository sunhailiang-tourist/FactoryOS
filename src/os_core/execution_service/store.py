...
业务关联：E-07 idempotency_key；E-09 evidence 数据源。
...
from os_core.shared_contracts.models.execution import ExecutionRecord
    ...
    session.execute(
      text(
        ...
        SELECT exec_id, tenant_id, verb, status, graph_id, graph_version,
               ...
               shadow_mode, params_json, dry_run, finished_at
