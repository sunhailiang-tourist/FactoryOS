...
| 模块 | 文件/路径 | 说明 |
|------|-----------|------|
| Step1 工程底座 | `pyproject.toml` · `apps/api/main.py` | FastAPI + `/health` · uv 依赖封版 |
...
| Step4 Connector | `connector_sdk/health.py` · `apps/api/routes/connectors.py` | C-01 mock health |
